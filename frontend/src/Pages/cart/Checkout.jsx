...
export const Checkout = () => {
  ...
  const handleclick = (data) => {
    ...
    axios
      .post('https://sugar-cosmatics.onrender.com/api/address', dataa)
      .then((res) => {
        getaddress();
  ...
  const getaddress = () => {
    axios
      .get(
        `https://sugar-cosmatics.onrender.com/api/address/${currentUser._id}`
      )
      .then((res) => {
          ...
          >
            ...
            >
              ...
              <Box w='100%' pr='0.5rem' pl='0.5rem' mt='0.25rem'>
                ...
                >
                  <Flex>
                    <Text fontSize='13px' fontWeight='450' color='#6c757d'>
                      Delivery Address
                    </Text>
                  </Flex>
                  <Flex>
              ...
              >
                {address != null ? (
                  ...
                  <Text>Add Address To Proceed Further</Text>
                )}
              </Box>
